...
# Creating histogram
plt.hist(data, bins=20, orientation='horizontal', histtype='bar', color='g', edgecolor='y')
plt.hist(avg_weight,bins=20,orientation='horizontal', histtype='bar', color='b', edgecolor='r')
plt.hist(X,bins=20,orientation='horizontal', histtype='bar', color='r', edgecolor='b')
